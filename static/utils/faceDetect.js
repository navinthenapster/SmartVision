//Parameters
const s = document.getElementById('faceDetect');
const sourceVideo = s.getAttribute("data-source");  //the source video to use
const uploadWidth = s.getAttribute("data-uploadWidth") || 640; //the width of the upload file
const mirror = s.getAttribute("data-mirror") || false; //mirror the boundary boxes
const scoreThreshold = s.getAttribute("data-scoreThreshold") || 0.5;
const apiServer = s.getAttribute("data-apiServer") || window.location.origin + '/image/faceDetect'; //the full TensorFlow Object Detection API server url
...
function postFile(file) {
    ...
    formdata.append("faceDetect", true);
